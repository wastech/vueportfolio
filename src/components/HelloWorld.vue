<template>
<div>
    <vueper-slides ref="myVueperSlides" :parallax="parallax" fixed-height="500px" :parallax-fixed-content="parallaxFixedContent">
        <vueper-slide v-for="(slide, i) in slides" :key="i" :image="slide.image" :title="parallaxFixedContent ? slide.title : ''" :content="parallaxFixedContent ? slide.content : ''" />
    </vueper-slides>
</div>
</template>
        ...
        return {
            ...
            slides: [{
                ...
                },
                {
                    ...
                    title: 'Clean, minimal & modern design'
                }
            ]
        }
    }
