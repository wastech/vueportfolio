    ...
    data() {
        return {
            items: [{
                ...
                {
                    image: 'https://cdn.dribbble.com/users/774375/screenshots/7517289/media/3b81b356fc9be5f3fd19076c88792ec4.png',
                    detail: 'PORTFOLIO',
                    text: ''
                },
                {
...
.card {
    ...
    border-bottom: 1.6px solid #228dff;

    border-radius: 16px 8px 200px 72px;
    -moz-border-radius: 16px 8px 200px 72px;
    -webkit-border-radius: 16px 8px 80px 20px;
